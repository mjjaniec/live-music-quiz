...
@Route(value = "old-answer", layout = PlayerView.class)
public class OldAnswerView extends VerticalLayout implements PlayerRoute {

    private Boolean artist = null;
    private Boolean title = null;
    private boolean bonus = false;

    public OldAnswerView(GameService gameService) {
        setSpacing(true);
        setPadding(true);
