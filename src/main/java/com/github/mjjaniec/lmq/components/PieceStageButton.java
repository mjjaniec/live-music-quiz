...
public class PieceStageButton extends Button {
    public PieceStageButton(
            GameStage.RoundPiece piece, GameStage.PieceStage pieceStage, Consumer<GameStage.RoundPiece> onActivate) {
        testId(
                this,
                "maestro/dj/piece-" + pieceStage.name() + "-" + piece.roundNumber + "-" + piece.pieceNumber.number());
