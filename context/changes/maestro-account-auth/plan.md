...
- [x] 4.1 Full CI-equivalent suite passes (verify -Pit -Pproduction) — 8d244d7
- [x] 4.2 Formatting passes (spotless:check) — 8d244d7

#### Manual

- [x] 4.3 /test/login is unreachable outside the integration-test profile — 8d244d7
